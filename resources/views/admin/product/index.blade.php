                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="pd_code" class="form-control"
                                            placeholder="Enter Code Product" :value="data.pd_code" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Produk Category</label>
                                        <input type="text" name="pd_ct_id" class="form-control"
                                            placeholder="Enter Produk Product" :value="data.pd_ct_id" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Product Name</label>
                                        <input type="text" name="pd_name" class="form-control"
                                            placeholder="Enter Price Product" :value="data.pd_name" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Product Price</label>
                                        <input type="text" name="pd_price" class="form-control"
                                            placeholder="Enter Price Product" :value="data.pd_price" required="">
                                    </div>
                                </div>
                            </div>
            ...
            var columns = [{
                ...
                },
                {
                    render: function(index, row, data, meta) {
                        ...
                        <a href="#" onclick="controller.deleteData(event, ${data.pd_id})" class="btn btn-sm btn-danger pull-right btn-block md-2">Delete</a>`;
                    },
                    orderable: false,
                    width: '200px',
                    class: 'text-center'
            ...
            var controller = new Vue({
                ...
                methods: {
                    ...
                    submitForm(event, id) {
                        ...
                        const _this = this;
                        var actionUrl = !this.editStatus ? this.actionUrl : this.actionUrl + '/' + this.data.pd_id;
                        var method = this.editStatus ? 'PUT' : 'POST';
